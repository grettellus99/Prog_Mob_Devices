...
import com.example.workoutic.models.ExerciseRoutineViewAdapter;
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if(view.getId() == R.id.ly_exercise_routine_especific_exercise_view){
                    ...
                    LinearLayout lyMenu = view.findViewById(R.id.ly_card_item_exercises_routine_menu_view);
                    LinearLayout lyData = view.findViewById(R.id.ly_card_item_exercises_routine_data_view);
